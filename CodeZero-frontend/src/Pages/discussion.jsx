...
const Discussion = () => {
  ...
  return (
    <section className="h-screen pt-20 mt-10 mb-10 flex justify-center ">
          ...
          <div className="flex-1 p-4 space-y-4 overflow-y-auto">
            ...
            <div className="flex justify-end">
              <div className="bg-blue-500 text-white px-5 py-2 rounded-lg rounded-tr-none max-w-xs">
                ...
                development. We aim to empower students through hands-on
                projects, workshops, and a vibrant tech community.
                <div className="text-xs text-gray-200 text-right mt-1">
                  time
                </div>
              </div>
