    ...
    <section className="bg-black overflow-hidden w-full min-h-screen flex flex-col items-center justify-center pt-14 sm:pt-24 lg:pt-0">
      <div className="about flex flex-col space-y-8 items-center w-3/5 lg:w-3/5">
        <p className="text-white text-xl text-center">
          "We, the <span className="text-blue-500">CodeZero</span> team, are a
          student-initiated technical community at Dayananda Sagar College of
          Engineering and part of Anvaya, a club driven by the Department of
          Artificial Intelligence and Machine Learning."
        </p>
        <p className="text-white text-xl text-center lg:text-justify">
          <span className="text-blue-500">CodeZero</span> is a dynamic coding
          club committed to fostering a community of tech enthusiasts. Our
          mission is to empower individuals through coding workshops,
          collaborative projects, and innovative challenges. We value
          creativity, collaboration, and continuous learning, providing a
          platform for members to enhance their skills and showcase their
          achievements.
        </p>
      </div>
