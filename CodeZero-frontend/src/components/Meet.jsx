  ...
  return (
    <div className="bg-black min-h-screen w-full overflow-x-hidden">
      ...
      {[0, 1].map((rowIndex) => (
        <div
          key={rowIndex}
          className="flex flex-col sm:flex-row items-center justify-center mt-6 space-y-6 sm:space-y-0 sm:space-x-4 md:space-x-8 lg:space-x-16 bg-black px-4"
        >
      ...
      <div
        ...
        style={{ backgroundImage: "url('./utils/enhanced_2.png')" }}
      >
