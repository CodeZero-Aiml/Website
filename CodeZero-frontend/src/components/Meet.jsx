...
const Meet = () => {
  return (
    <div className="bg-black min-h-screen">
        <div>
<h1 class="text-5xl font-bold bg-gradient-to-r from-[#379AE6] to-[#f6f6f6] text-transparent bg-clip-text text-center py-5 font-normal">
Meet The Team
</h1>
</div>
...
<div className="bg-[url('/utils/Premium%20Photo%20_%20Digital%20Grid%20Vertical%20Background%201.png')]  bg-center min-h-screen mt-24">
</div>
